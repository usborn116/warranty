...
ActiveRecord::Schema[7.0].define(version: 2023_05_15_224653) do
  ...
  create_table "warranty_cards", force: :cascade do |t|
    t.bigint "item_id", null: false
    t.string "code"
    t.string "contact"
    t.date "expiration"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id"], name: "index_warranty_cards_on_item_id"
  end
  ...
  add_foreign_key "warranty_cards", "items"
end
